...
class CollectDataNode(Node):
    def __init__(self):
        ...
        self.csv_file = os.path.join(self.data_dir, 'drone_state_data_z.csv')
            ...
            try:
                ...
                for _ in range(5):
                    self.collect_and_publish_pcmd(duration=5, interval=1 / self.freq, output_file='drone_state_data_pcmd.csv',
                                                  x_input=0, y_input=0, z_input=50, yaw_input=0)
                    self.collect_and_publish_pcmd(duration=5, interval=1 / self.freq, output_file='drone_state_data_pcmd.csv',
                                                  x_input=0, y_input=0, z_input=-50, yaw_input=0)
...
if __name__ == '__main__':
    ...
    #                                               x_input=0, y_input=0, z_input=-20, yaw_input=0)  
    #                 self.collect_and_publish_pcmd(duration=2, interval=1/self.freq, output_file='drone_state_data_no_pcmd.csv',
    #                                               x_input=0, y_input=0, z_input=80, yaw_input=0)
    #                 self.collect_and_publish_pcmd(duration=6, interval=1/self.freq, output_file='drone_state_data_pcmd.csv',
    #                                               x_input=0, y_input=0, z_input=60, yaw_input=0)                
    #                 self.collect_and_publish_pcmd(duration=3, interval=1/self.freq, output_file='drone_state_data_no_pcmd.csv',
    #                                               x_input=0, y_input=0, z_input=-70, yaw_input=0)
    #                 self.collect_and_publish_pcmd(duration=4, interval=1/self.freq, output_file='drone_state_data_pcmd.csv',
    #                                               x_input=0, y_input=0, z_input=60, yaw_input=0)                
