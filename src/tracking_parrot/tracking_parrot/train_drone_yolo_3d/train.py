...
if __name__ == "__main__":
    ...
    data_yaml = "/home/yousa/anafi_simulation/src/tracking_parrot/tracking_parrot/train_drone_yolo_3d/data.yaml"  # Path to the data.yaml file


    # Specify the output directory
    output_dir = "/home/yousa/anafi_simulation/src/tracking_parrot/tracking_parrot/train_drone_yolo_3d"  # Custom output directory for saving results
