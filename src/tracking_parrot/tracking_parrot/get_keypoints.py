...
class GetKeyPoints(Node):
    def __init__(self):
        ...
        self.model_path="/home/yousa/anafi_simulation/runs/detect/drone_detection2/weights/best.pt"

        self.model = YOLO(self.model_path)

        self.save_dir_img = os.path.join(os.path.expanduser("~"), 'anafi_simulation','data','keypoints_refine','img')
        self.save_dir_keypoints = os.path.join(os.path.expanduser("~"), 'anafi_simulation','data','keypoints_refine','point')
